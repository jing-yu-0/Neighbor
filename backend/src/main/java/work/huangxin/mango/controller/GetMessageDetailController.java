...
public class GetMessageDetailController {
    ...
    @PostMapping("/getMessage/getAllMessageDetail/{province}/{city}/{district}/{community}/{longitude}/{latitude}/{pageNumber}")
    public List<MangoMessage> getAllMessageDetail(@PathVariable String province,@PathVariable String city,@PathVariable String district,@PathVariable String community, @PathVariable Double longitude, @PathVariable Double latitude, @PathVariable Integer pageNumber) {

        PageHelper.startPage(pageNumber, 8);

        PageInfo<MangoMessage> pageInfo = new PageInfo<MangoMessage>(mangoMessageDetailService.getAllMessageByLocation(province,city,district,community,longitude,latitude));
    ...
    @PostMapping("/getMessage/getAllMessageDetail/{province}/{city}/{district}/{community}/{longitude}/{latitude}/{categoryId}/{pageNumber}")
    public List<MangoMessage> getMessageByCategoryId(@PathVariable String province,@PathVariable String city,@PathVariable String district,@PathVariable String community, @PathVariable Double longitude, @PathVariable Double latitude,@PathVariable Integer categoryId, @PathVariable Integer pageNumber) {
        PageHelper.startPage(pageNumber, 8);

        PageInfo<MangoMessage> pageInfo = new PageInfo<MangoMessage>(mangoMessageDetailService.getMessageByLocationCategoryId(province,city,district,community,longitude,latitude,categoryId));
