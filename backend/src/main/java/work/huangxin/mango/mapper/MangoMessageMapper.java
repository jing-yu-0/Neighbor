...
public interface MangoMessageMapper extends Mapper<MangoMessage> {
    ...
    List<MangoMessage> getAllMessageByLocation(String province,String city,String district,String community,Double longitude,Double latitude);

    List<MangoMessage> getMessageByCategoryId(Integer id);

    List<MangoMessage> getMessageByLocationCategoryId(String province,String city,String district,String community,Double longitude,Double latitude,Integer id);
