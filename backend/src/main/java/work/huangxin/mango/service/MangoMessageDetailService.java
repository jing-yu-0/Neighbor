...
public class MangoMessageDetailService extends SameService<MangoMessage> {
    ...
    public List<MangoMessage> getAllMessageByLocation(String province,String city,String district,String community,Double longitude,Double latitude) {
        return mangoMessageMapper.getAllMessageByLocation(province,city,district,community,longitude,latitude);
    }
    ...
    public List<MangoMessage> getMessageByLocationCategoryId(String province,String city,String district,String community,Double longitude,Double latitude,Integer id) {
        return mangoMessageMapper.getMessageByLocationCategoryId(province,city,district,community,longitude,latitude,id);
    }
